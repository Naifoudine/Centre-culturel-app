...
<form method="post" action="{{ route('attributions.index') }}">
    ...
    <div class="form-group">
        ...
        <input class="form-control" type="time" id="heureDebut" name="heureDebut" min="08:00" max="18:00">
    </div>

    <div class="form-group">
        <label for="heureFin">Jusqu'à :</label>
        <input class="form-control" type="time" id="heureFin" name="heureFin" min="08:00" max="18:00">
    </div>
